...
description: "Offers the user an informed choice about how much response depth to consume before answering. Controls response length, depth, or token budget."
version: 1.0.0
...
Use the same calibration guidance as [context-budget skill:
